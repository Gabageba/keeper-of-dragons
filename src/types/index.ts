...
// Доменные типы разнесены по файлам; здесь — barrel-реэкспорт и агрегатные типы
// сохранения, охватывающие все домены.

export type { BiomeType, TerrainDef, IslandDef, Placement, ExpeditionRouteDef } from './island';
export type {
  Element,
  Rarity,
  DragonDef,
...
export type { PlantDef, PlantSlotState, GardenState } from './plant';
export type { BuildingDef, OrderDef } from './building';
